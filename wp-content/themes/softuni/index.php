      ...
      <div class="row">
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="courses-details.html"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/item1.jpg" class="img-fluid rounded-3" alt="image"></a>
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="courses-details.html"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/item2.jpg" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="courses-details.html"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/item3.jpg" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="courses-details.html"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/item4.jpg" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="courses-details.html"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/item5.jpg" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="courses-details.html"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/item6.jpg" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="courses-details.html"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/item7.jpg" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3 mb-5">
          ...
          <div class="card rounded-4 border-0 shadow-sm p-3 position-relative">
            <a href="courses-details.html"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/item8.jpg" class="img-fluid rounded-3" alt="image"></a>
            <div class="card-body p-0">
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide pe-md-5">
                <div class="my-4">
                  ...
                  <div class="row">
                    <div class="col-3"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/reviwer1.jpg" alt="img" class="img-fluid rounded-circle">
                    </div>
                    <div class="col-9">
              ...
              <div class="swiper-slide pe-md-5">
                <div class="my-4">
                  <p class="text-muted">“Condimentum vel viverra morbi quisque lobortis eu leo. A nulla pulvinar at
                    ...
                    nunc sapien egestas at cursus. ”</p>
                  <div class="row">
                    <div class="col-3"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/reviwer2.jpg" alt="img" class="img-fluid rounded-circle">
                    </div>
                    <div class="col-9">
              ...
              <div class="swiper-slide pe-md-5">
                <div class="my-4">
                  <p class="text-muted">“Condimentum vel viverra morbi quisque lobortis eu leo. A nulla pulvinar at
                    ...
                    nunc sapien egestas at cursus. ”</p>
                  <div class="row">
                    <div class="col-3"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/reviwer3.jpg" alt="img" class="img-fluid rounded-circle">
                    </div>
                    <div class="col-9">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col mb-5">
          <div class="team-member position-relative card rounded-4 border-0 shadow-sm p-3">
            <div class="image-holder zoom-effect rounded-3">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/teacher1.jpg" class="img-fluid rounded-3" alt="image">
        ...
        <div class="col mb-5">
          <div class="team-member position-relative card rounded-4 border-0 shadow-sm p-3">
            <div class="image-holder zoom-effect rounded-3">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/teacher2.jpg" class="img-fluid rounded-3" alt="image">
              <ul class="social-links list-unstyled position-absolute">
                <li>
                  <a href="#">
                    <svg class="facebook text-dark" width="25" height="25" aria-hidden="true">
        ...
        <div class="col mb-5">
          <div class="team-member position-relative card rounded-4 border-0 shadow-sm p-3">
            <div class="image-holder zoom-effect rounded-3">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/teacher3.jpg" class="img-fluid rounded-3" alt="image">
              <ul class="social-links list-unstyled position-absolute">
                <li>
                  <a href="#">
                    <svg class="facebook text-dark" width="25" height="25" aria-hidden="true">
        ...
        <div class="col mb-5">
          <div class="team-member position-relative card rounded-4 border-0 shadow-sm p-3">
            <div class="image-holder zoom-effect rounded-3">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/teacher4.jpg" class="img-fluid rounded-3" alt="image">
              <ul class="social-links list-unstyled position-absolute">
                <li>
                  <a href="#">
                    <svg class="facebook text-dark" width="25" height="25" aria-hidden="true">
        ...
        <div class="col mb-5">
          <div class="team-member position-relative card rounded-4 border-0 shadow-sm p-3">
            <div class="image-holder zoom-effect rounded-3">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/teacher5.jpg" class="img-fluid rounded-3" alt="image">
              <ul class="social-links list-unstyled position-absolute">
                <li>
                  <a href="#">
                    <svg class="facebook text-dark" width="25" height="25" aria-hidden="true">
